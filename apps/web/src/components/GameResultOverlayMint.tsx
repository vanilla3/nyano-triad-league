    ...
    >
      ...
      >
        ...
        <div className="mint-result__actions">
          {onRematch && (
            <button className="mint-result__btn mint-pressable mint-hit mint-pressable--pill" onClick={onRematch}>
              🔄 もう一回
            </button>
          )}
          {onReplay && (
            <button className="mint-result__btn mint-pressable mint-hit mint-pressable--pill" onClick={onReplay}>
              📼 リプレイ
            </button>
          )}
          {onShare && (
            <button className="mint-result__btn mint-result__btn--primary mint-pressable mint-hit mint-pressable--pill" onClick={onShare}>
              📤 シェア
            </button>
          )}
          {!onRematch && !onReplay && !onShare && onDismiss && (
            <button className="mint-result__btn mint-result__btn--primary mint-pressable mint-hit mint-pressable--pill" onClick={onDismiss}>
              閉じる
            </button>
          )}
        </div>
