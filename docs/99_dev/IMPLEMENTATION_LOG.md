...
- apps/web/e2e/mint-app-screens-guardrails.spec.ts
  - Added Decks mint browser interaction guardrail:
    - hand combobox selection reflects in chips (`��D: �p�[`)
    - query input reflects in chips (`����: 1`)
...
### What
- apps/web/src/pages/Start.tsx
  - Updated done state copy to Japanese-first: `�������ł��܂����B�f�b�L / �A���[�i �֐i�߂܂��B`
  - Updated back link label: `�z�[���֖߂�`.
- apps/web/src/pages/Replay.tsx
  - Replaced ambiguous `���� | step ...` with clearer playback wording: `�Đ��ʒu | ... ��`.
...
- apps/web/src/components/PlayerSidePanelMint.tsx
  - Changed remaining-card visible label to `�c��J�[�h`.
  - Changed aria-label to Japanese-first wording: `Player A/B �̎c��J�[�h N`.
...
## 2026-02-18 - Home����2�X�e�b�v�� + stage-focus���艻

### What
- apps/web/src/pages/Home.tsx
  - �z�[���̃I���{�[�f�B���O���u2�X�e�b�v�v�����֐������A3�X�e�b�v�ڃJ�[�h���폜�B
  - ���[�U�[�����łȂ��i�������\���i������ԃ��b�Z�[�W�j���폜���āA�ē������Ȍ����B
- apps/web/src/mint-theme/mint-theme.css
  - stage focus + hand dock ���p���� board �ő啝����������Aboard/dock �̏d�Ȃ��}���B
- apps/web/e2e/stage-focus.spec.ts
  - replay load/error/retry �̕�������p���L�֒Ǐ]�i`Load replay` / `�Đ���ǂݍ���` ���j�B
  - �����Ǎ����i�ǂݍ��ݒ�... disabled�j�ł����s�񕜃e�X�g�����肷��悤�ɕ���������B
- apps/web/e2e/home.spec.ts
  - �z�[����2�X�e�b�v�\���ɂȂ������Ƃɍ��킹�A�s�v��3�X�e�b�v���Ғl���폜�B
...
### What
- apps/web/src/pages/Start.tsx
  - 1���X�^�[�g������2�X�e�b�v�\���ɓ���i3�X�e�b�v�ڃJ�[�h��P���j�B
- apps/web/src/pages/Match.tsx
  - �t�H�[�J�X����/��ԃt�B�[�h�o�b�N����{��x�[�X���i�p��͊��ʕ��L�j�B
  - `Hide/Show Controls` �� `Hide/Show HUD` �͕\����������{�ꉻ���Aaria-label ���p��݊��ňێ��B
  - ���LURL�������G���[�Ȃǂ���{�ꉻ�B
- apps/web/src/pages/Replay.tsx
  - �t�H�[�J�X����t�B�[�h�o�b�N�icontrols/setup/highlight/start�j����{��x�[�X���B
- apps/web/src/pages/Stream.tsx
  - Quick nav �ƃX�e�b�v���o���iStep 1/3/4�j����{��x�[�X���B
  - Broadcast�n����/�{�^����������{��x�[�X�ɐ����B
- apps/web/e2e/stage-focus.spec.ts
  - recovery�P�[�X�� share param decode failure (`t=invalid`) �Ɋ񂹂Č���_�I�Ɉ��艻�B
...
### What
- apps/web/src/pages/Match.tsx
  - Changed replay-unavailable toast title to Japanese-first (`���v���C (Replay)`).
  - Replaced ambiguous stage-focus default feedback from `��������` to `�����I�����Ă�������`.
  - Updated visible commit button text to Japanese-first (`�m�� (Commit)`) while keeping English aria-labels for E2E compatibility.
- apps/web/src/pages/Replay.tsx
  - Changed initial empty-state error copy to Japanese-first with English parenthetical.
  - Changed overlay-related toast titles/messages to Japanese-first (`�I�[�o�[���C (Overlay)`).
  - Replaced ambiguous stage-focus default feedback from `��������` to `�����I�����Ă�������`.
  - Updated stream tools wording to Japanese-first (`�I�[�o�[���C...`) with English term parenthetical.
...
### What
- apps/web/src/components/MatchDrawerMint.tsx
  - Drawer title changed to Japanese (`�ڍ�`) and toggle glyph changed from text to symbol (`��`).
...
- apps/web/src/components/match/MatchSetupPanelMint.tsx
  ...
  - Updated section labels to: �ΐ�ݒ� / ���݂̐ݒ� / ��{�ݒ� / �ǉ��ݒ� / �ڍ׃p�����[�^.
...
- apps/web/src/pages/Home.tsx
  - Replaced toast suffix wording from ���� to ���{�ς�.
...
- apps/web/src/pages/Stream.tsx
  - Simplified quick-action labels to JP-first (`�ΐ�`, `�I�[�o�[���C`, `���v���C`, `�C�x���g`).
- apps/web/src/pages/Home.tsx
...
### What
- apps/web/src/pages/Replay.tsx
  - Localized additional visible copy to JP-first (`�΋ǃ��OJSON`, `�ΐ�ID`, `����`, save notifications, overlay URL copy labels).
...
- `apps/web/src/pages/Stream.tsx`
  ...
  - Localized stream summary labels (`オーバーレイ`, `対戦バス`) and link labels (`イベント`, `対戦`, `リプレイ`, `オーバーレイ`).
...
- `apps/web/src/pages/Overlay.tsx`
  ...
  - Localized vote status labels to `受付中` / `受付終了` while preserving compatibility via `aria-label` (`OPEN`/`CLOSED`).
...
- `apps/web/src/pages/Replay.tsx`
  - Replaced mixed EN user-facing labels with JP-first wording:
    - `リプレイ読込（Replay from transcript）` -> `リプレイ読込`
    - `リプレイを読み込む (Load replay)` -> `リプレイを読み込む`
    - `エラー / Error` -> `エラー`
    - `再読込する (Retry load)` -> `再読込する`
    - `共有パラメータをクリア (Clear share params)` -> `共有パラメータをクリア`
    - Removed EN parentheticals from focus guard/transport hidden messages.
  - Updated stream-assist copy to JP-first (`step` -> `手順`, placeholder `Playground` -> `プレイグラウンド`).
  - Updated copy labels used in toasts (`transcript`/`result` -> `対局ログJSON`/`結果JSON`).
- E2E selector compatibility updates:
...
- `apps/web/src/pages/Replay.tsx`
  - Removed remaining mixed-English focus wording in visible controls/feedback:
    - `操作を隠す (Hide controls)` / `操作を表示 (Show controls)` -> `操作を隠す` / `操作を表示`
    - `操作を隠しました (Controls hidden)` / `設定を表示しました (Setup shown)` -> JP-only feedback
    - highlight status text -> JP-only (`見どころ N件`)
    - `先頭へ移動しました (Jumped to start)` -> `先頭へ移動しました`
- `apps/web/src/components/match/MatchSetupPanelMint.tsx`
  - Reworded advanced options from dev-centric terms to user-facing JP:
    - `Layer4 chain cap` -> `連鎖上限`
    - invalid `ccap` message -> JP-first explanatory wording
    - `Layer4 実験設定...` -> `追加設定...`
    - `rulesetId` label -> `ルールID`
- E2E compatibility updates
  - `apps/web/e2e/stage-focus.spec.ts`
...
### What
- `apps/web/src/pages/Home.tsx`
  - Main menu titles changed to JP-first (`アリーナ`, `デッキ`, `リプレイ`, `配信`).
- `apps/web/src/pages/Events.tsx`
  - Quick action labels changed from mixed `日本語 (English)` to JP-first labels.
- `apps/web/src/pages/Decks.tsx`
  - Mint tab labels changed to JP-first (`デッキ`, `アリーナ`, `イベント`, `リプレイ`, `配信`).
